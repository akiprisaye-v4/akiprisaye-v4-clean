              ...
              <div className="p-4 bg-green-900/30 border border-green-700 rounded-lg text-green-200">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Un email de vérification a été envoyé à <strong>{email}</strong>. Vérifiez
                      votre boîte de réception et cliquez sur le lien pour activer votre compte.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-6 p-3 bg-slate-800/70 border border-slate-700 rounded-lg text-xs">
                  {firebaseHealthy ? (
                    ...
                    <div className="text-amber-300">
                      ...
                      {wrongApiKeyDetected && (
                        <p className="mt-1">
                          Clé API Firebase incorrecte détectée dans ce build. Vérifiez le secret
                          VITE_FIREBASE_API_KEY dans GitHub Actions.
                        </p>
                      )}
                      {missingCriticalEnvKeys.length > 0 && (
                        <p className="mt-1 break-words">
                          Clés manquantes : {missingCriticalEnvKeys.join(', ')}
                        </p>
                      )}
                    </div>
                  )}
