...
const ProductList = lazy(() =>
  import('./pages/admin/products/ProductList').then((m) => ({ default: m.ProductList }))
);
const ProductForm = lazy(() =>
  import('./pages/admin/products/ProductForm').then((m) => ({ default: m.ProductForm }))
);
const ProductDetail = lazy(() =>
  import('./pages/admin/products/ProductDetail').then((m) => ({ default: m.ProductDetail }))
);
const ImportPage = lazy(() =>
  import('./pages/admin/import/ImportPage').then((m) => ({ default: m.ImportPage }))
);
...
const DelaisTensionsLogistiques = lazy(
  () => import('./pages/recherche-prix/DelaisTensionsLogistiques')
);
...
const RechercheAbonnementsInternet = lazy(
  () => import('./pages/recherche-prix/AbonnementsInternet')
);
...
const ComprendrePromotionsPrixBarres = lazy(
  () => import('./pages/ressources/ComprendrePromotionsPrixBarres')
);
const PourquoiPrixVarieSansChangement = lazy(
  () => import('./pages/ressources/PourquoiPrixVarieSansChangement')
);
...
const InflationAlimentaireDOMAnalyse = lazy(
  () => import('./pages/pillar/InflationAlimentaireDOMAnalyse')
);
                            ...
                            <Suspense fallback={<LoadingFallback />}>
                              <Routes>
                                ...
                                >
                                  ...
                                  <Route
                                    path="calculs-batiment"
                                    element={<AdminCalculsBatiment />}
                                  />
                                ...
                                <Route path="/" element={<Layout />}>
                                  ...
                                  <Route
                                    path="espace-pro-batiment"
                                    element={<Navigate to="/espace-pro" replace />}
                                  />
                                  <Route
                                    path="espace-createur"
                                    element={
                                      <RequireCreator>
                                        <Suspense fallback={<LoadingFallback />}>
                                          <EspaceCreateur />
                                  ...
                                  />
                                  <Route
                                    path="activation-createur"
                                    element={<ActivationCreateur />}
                                  />
                                  ...
                                  <Route
                                    path="analyse-photo-produit"
                                    element={<ProductPhotoAnalysis />}
                                  />
                                  <Route path="product/:barcode" element={<ProductScanResult />} />
                                  <Route path="ocr" element={<OCRHub />} />
                                  <Route
                                    path="comparaison-enseignes"
                                    element={<ComparaisonEnseignes />}
                                  />
                                  ...
                                  <Route
                                    path="liste-intelligente"
                                    element={<SmartShoppingListPage />}
                                  />
                                  <Route
                                    path="tableau-inflation"
                                    element={<InflationDashboardPage />}
                                  />
                                  <Route
                                    path="gamification"
                                  ...
                                  <Route
                                    path="observatoire-temps-reel"
                                    element={<ObservatoireTempsReel />}
                                  />
                                  ...
                                  <Route
                                    ...
                                    element={<ComparatifConcurrence />}
                                  />
                                  <Route
                                    path="licence-institution"
                                    element={<LicenceInstitution />}
                                  />
                                  ...
                                  <Route
                                    path="comparateur-carburants"
                                    element={<FuelComparator />}
                                  />
                                  <Route
                                    path="stations-proximite"
                                    element={<StationsProximite />}
                                  />
                                  <Route path="prix-produit" element={<ProductPriceLookup />} />
                                  <Route path="scan-eeg" element={<ESLScannerPage />} />
                                  <Route
                                    path="enquete-carburants"
                                    element={<EnqueteCarburants />}
                                  />
                                  <Route
                                    path="conference-carburants"
                                    element={<ConferenceCarburants />}
                                  />
                                  <Route
                                    path="comparateur-assurances"
                                    element={<InsuranceComparator />}
                                  />
                                  <Route
                                    path="comparateur-formations"
                                    element={<TrainingComparator />}
                                  />
                                  <Route
                                    path="comparateur-services"
                                    element={<ServiceComparator />}
                                  />
                                  <Route
                                    path="comparateur-location-voiture"
                                    element={<CarRentalComparator />}
                                  />
                                  <Route
                                    path="comparateur-materiaux-batiment"
                                    element={<BuildingMaterialsComparator />}
                                  />
                                  <Route
                                    path="evaluation-cosmetique"
                                    element={<EvaluationCosmetique />}
                                  />
                                  <Route
                                    path="comparateur-avance"
                                    element={<EnhancedComparator />}
                                  />
                                  <Route path="compare" element={<Compare />} />
                                  <Route
                                    path="comparateur-citoyen"
                                    element={<ComparateurCitoyen />}
                                  />
                                  ...
                                  <Route
                                    path="observatoire/methodologie"
                                    element={<ObservatoryMethodology />}
                                  />
                                  <Route
                                    path="recherche-prix/delais-logistiques"
                                    element={<DelaisTensionsLogistiques />}
                                  />
                                  <Route
                                    path="recherche-prix/indice-logistique"
                                    element={<IndiceLogistique />}
                                  />
                                  <Route
                                    path="recherche-prix/pourquoi-delais-produit"
                                    element={<PourquoiDelaisProduit />}
                                  />
                                  <Route
                                    path="recherche-prix/avions"
                                    element={<RechercheAvions />}
                                  />
                                  <Route
                                    path="recherche-prix/bateaux"
                                    element={<RechercheBateaux />}
                                  />
                                  <Route path="recherche-prix/eau" element={<RechercheEau />} />
                                  <Route
                                    path="recherche-prix/electricite"
                                    element={<RechercheElectricite />}
                                  />
                                  <Route path="recherche-prix/fret" element={<RechercheFret />} />
                                  <Route
                                    path="recherche-prix/fret-aerien"
                                    element={<RechercheFretAerien />}
                                  />
                                  <Route
                                    path="recherche-prix/abonnements-internet"
                                    element={<RechercheAbonnementsInternet />}
                                  />
                                  <Route
                                    path="recherche-prix/abonnements-mobile"
                                    element={<RechercheAbonnementsMobile />}
                                  />
                                  <Route
                                    path="ressources/questions-logistique-dom"
                                    element={<QuestionsLogistiqueDOM />}
                                  />
                                  <Route
                                    path="ressources/glossaire-logistique-dom"
                                    element={<GlossaireLogistiqueDOM />}
                                  />
                                  <Route
                                    path="ressources/comprendre-promotions-prix-barres"
                                    element={<ComprendrePromotionsPrixBarres />}
                                  />
                                  <Route
                                    path="ressources/pourquoi-prix-varie-sans-changement"
                                    element={<PourquoiPrixVarieSansChangement />}
                                  />
                                  <Route
                                    path="comparateur-territoires"
                                    element={<CrossTerritoryComparator />}
                                  />
                                  <Route
                                    path="comparaison-territoires"
                                    element={<ComparaisonTerritoires />}
                                  />
                                  <Route
                                    path="inflation-categories"
                                    element={<InflationRateTracker />}
                                  />
                                  <Route
                                    path="couverture-territoires"
                                    element={<TerritoryCoverageReport />}
                                  />
                                  <Route
                                    path="contact-collectivites"
                                    element={<ContactCollectivites />}
                                  />
                                  <Route path="dossier-media" element={<DossierMedia />} />
                                  <Route
                                    path="budget-reel-mensuel"
                                    element={<BudgetReelMensuel />}
                                  />
                                  ...
                                  <Route
                                    path="calculateur-octroi"
                                    element={<CalculateurOctroi />}
                                  />
                                  <Route path="enquete-octroi-mer" element={<EnqueteOctroiMer />} />
                                  <Route
                                    path="conference-octroi-mer"
                                    element={<ConferenceOctroiMer />}
                                  />
                                  <Route path="enquete-eau" element={<EnqueteEau />} />
                                  <Route path="conference-eau" element={<ConferenceEau />} />
                                  <Route
                                    path="calculateur-batiment"
                                    element={<CalculateurBatiment />}
                                  />
                                  <Route
                                    path="simulateur-budget"
                                    element={<SimulateurBudgetFamilial />}
                                  />
                                  ...
                                  <Route
                                    path="dossier-investisseurs"
                                    element={<DossierInvestisseurs />}
                                  />
                                  ...
                                  <Route
                                    path="territoire/:territory/scanner"
                                    element={<TerritoryScanner />}
                                  />
                                  <Route
                                    path="guide-territoire"
                                    element={<GuideIntelligentTerritoires />}
                                  />
                                  ...
                                  />
                                  <Route
                                    path="alertes-predictives"
                                    element={<AlertesPredictives />}
                                  />
                                  <Route
                                  ...
                                  <Route
                                    path="evaluation-magasins"
                                    element={<EvaluationMagasins />}
                                  />
                                  <Route
                                    path="portail-developpeurs"
                                    element={<PortailDeveloppeurs />}
                                  />
                                  ...
                                  <Route
                                    path="moins-cher/:territory"
                                    element={<SEOMoinsChersPage />}
                                  />
                                  <Route
                                    path="moins-cher/:territory/:category"
                                    element={<SEOMoinsChersPage />}
                                  />
                                  <Route path="marque/:slug" element={<SEOBrandPage />} />
                                  <Route
                                    path="prix-enseigne/:retailer/:territory"
                                    element={<SEOEnseignePrixPage />}
                                  />
                                  <Route path="guide-prix/:slug" element={<SEOGuidePrixPage />} />
                                  <Route
                                    path="comparateur/:slug"
                                    element={<SEOComparateurSlugPage />}
                                  />
                                  <Route path="landing" element={<LandingPage />} />
                                  <Route path="devenir-partenaire" element={<PartnerPage />} />
                                  <Route
                                    path="guide-prix-alimentaire-dom"
                                    element={<GuidePrixAlimentaireDOM />}
                                  />
                                  <Route
                                    path="comparateur-supermarches-dom"
                                    element={<ComparateurSuperMarchesDOM />}
                                  />
                                  <Route
                                    path="inflation-alimentaire-dom"
                                    element={<InflationAlimentaireDOMAnalyse />}
                                  />
                                  <Route
                                    path="ou-faire-courses-dom"
                                    element={<OuFaireCoursesDOMPage />}
                                  />
                                  ...
                                  />
                                  <Route
                                    path="seo-loop-dashboard"
                                    element={
                                      <RequireAdmin>
                                        <SeoLoopDashboardPage />
                                      </RequireAdmin>
                                    }
                                  />
                                  <Route
                                  ...
                                  />
                                  <Route
                                    path="auto-seo-dashboard"
                                    element={
                                      <RequireAdmin>
                                        <AutoSeoDashboardPage />
                                      </RequireAdmin>
                                    }
                                  />
                                  ...
                                  <Route
                                    path="vs/:slug"
                                    element={<SEOCompetitorComparisonPage />}
                                  />
                                  ...
                                  <Route
                                    path="top-deals-du-jour"
                                    element={<TopDealsDuJourPage />}
                                  />
